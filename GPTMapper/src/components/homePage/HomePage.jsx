...
//     async function fetchPhotoData(topic) {
//       const response = await fetch('http://localhost:3000/getRoadmap?topic="Something"', {
//         headers: {
...
//                 <button className="btn-2" onClick={()=>fetchPhotoData("something")}>Get</button>
//               </div>
//             </div>
//           </div>
//         </div>
...
//     fetchPhotoData(inputValue); // Call fetchPhotoData with the current input value
//   };
